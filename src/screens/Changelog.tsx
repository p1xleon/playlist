    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Card>
        ...
        <Text style={styles.text}>
          {'\u25CF'} Added new list - Dropped, for games you have played, but
          are not your type =(
        </Text>
        <Text style={styles.text}>
          {'\u25CF'} Enhanced filtering in game results for a more refined
          experience
        </Text>
        <Text style={styles.text}>
          {'\u25CF'} Implemented a cache manager, to keep the cache in check =)
        </Text>
        <Text style={styles.text}>
